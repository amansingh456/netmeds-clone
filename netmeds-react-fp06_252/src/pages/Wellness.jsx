    ...
    return (
        <Box bg={"#F3F7FB"}>
            ...
            <Box bg={"#F3F7FB"} height={600} mb={5}>
                <Box rounded={15} pt={5} ml={4} height={550} bg={"white"} mr={4}>
                    <Box pl={10} pr={10}>
            ...
            <Box bg={"#F3F7FB"} height={530} mb={10}>
                <Box rounded={15} ml={4} height={500} background="white" mr={4}>
                    <Box background="white" pl={10} pr={10}>
            ...
            {/* ########   COVID ESSENTIALS  Start ............ */}

            <Box bg={"#F3F7FB"} height={530} mb={10}>
                <Box rounded={15} pt={5} ml={4} height={500} background="white" mr={4}>
                    <Box background="white" pl={10} pr={10}>
                        <Text fontSize="sm" color={"#6F7284"}>
                            Covid Essentials
                        </Text>
